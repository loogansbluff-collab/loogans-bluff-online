...
export default function IndustrialCage({ position, emissiveColor, lightColor, intensity, distance, basicHousing = false }: Props) {
  ...
  return (
    <group position={position}>
      <mesh position={[0, cordLength / 2, 0]}>
        ...
        {basicHousing ? <meshBasicMaterial color="#2f343a" /> : <meshStandardMaterial color="#2f343a" roughness={0.8} />}
      </mesh>
      <mesh>
      ...
      <mesh rotation={[Math.PI / 2, 0, 0]}>
        ...
        {basicHousing ? <meshBasicMaterial color="#363b42" /> : <meshStandardMaterial color="#363b42" roughness={0.8} />}
      </mesh>
